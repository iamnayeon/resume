...
const SkillSection = () => {
  return (
    <SectionContainer title="이런 기술을 사용합니다">
      <S.ListContainer>
        <GeneralS.ListItem>
          <GeneralS.PointText>Javascript ES6+</GeneralS.PointText> 로 개발 해오고 있으며 동적
          언어라는 단점을 보완하기 위해 <GeneralS.PointText>TypeScript</GeneralS.PointText>를
          사용합니다.
        </GeneralS.ListItem>
        <GeneralS.ListItem>
        ...
        <GeneralS.ListItem>
          JS 기반 3D 라이브러리 <GeneralS.PointText>Three.js</GeneralS.PointText>로 구현된 회사의
          주요 기능을 유지보수해본 경험이 있습니다.
        </GeneralS.ListItem>
        <GeneralS.ListItem>
          <GeneralS.PointText>AWS S3, Route 53, CloudFront</GeneralS.PointText>를 활용하여
          웹사이트를 배포, 서비스되고 있는 웹서비스의 도메인을 변경해 본 경험이 있습니다.
        </GeneralS.ListItem>
      </S.ListContainer>
    </SectionContainer>
  );
